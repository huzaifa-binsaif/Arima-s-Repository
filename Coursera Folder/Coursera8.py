import json
# json.loads(x) takes a string and produces (a dictionary or a list) as output.
# we can ask for the type 'type(x)'
# you can ask for its keys 'x.keys()'


# json.dumps() converts a python dict into a string
# we can sort the keys with sort_keys = True
# and we can also use the indent parameter to get a string with indentations
res = {
  "search_metadata": {
    "count": 3,
    "completed_in": 0.015,
...
for res3 in res2:
    ...
    res4 = res3['user']
    #print(type(res4))
    print(res4['screen_name'],res4['name'])
